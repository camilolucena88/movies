        ...
        <div className="container px-5 py-24 mx-auto">
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded"
                     src={"/assets/images/movie-covers/"+payload.img}></img>
                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    <h2 className="text-sm title-font text-gray-500 tracking-widest">{payload.genres[0]}</h2>
                    ...
                    <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                        <div className="flex">
                            ...
                            {payload.genres.map((genre) => {
                                return <span className="m-1 badge text-white bg-primary">{genre}</span>
                            })}
                        </div>
                    </div>
                    <div className="flex">
